...
<body>
     ...
     <nav class="navbar navbar-default">
         ...
         <div class="navbar-header">
             ...
             <a class="navbar-brand" href="main.jsp"><img src="../img/spider-web.png" alt="" /><span>EduSpider</span></a>
         </div>
        <ul class="nav navbar-nav navbar-right">
            <li><a href="../main/MainForm.jsp">Home</a></li>
            <li class="dropdown">
            <% if (id == null) { %>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="../member/SignUpForm.jsp">회원가입</a></li>
                </ul>
            <% } else { %>
            	<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="dropdown-menu">
                    ...
                    <% if (mDto.getGrade().equals("manager")) { %>
                    	<% if (request.getRequestURI().equalsIgnoreCase("/Hellow_World/manage/ManageForm.jsp")) { %>
                    		<li><a href="../main/MainForm.jsp">사용자 페이지로 이동</a></li>  
