...
<%
	...
	if(id.equals("") || password.equals(""))
		script.println(JSFunction.executeBackAlert("아이디 또는 바꿀 비밀번호를 입력하지 않았습니다. 제대로 입력해주세요."));
	...
	// 페스워드 수정 실패
		...
		script.println(JSFunction.executeBackAlert("아이디를 알맞게 입력하지 않았습니다. 제대로 입력해주세요."));
	}
