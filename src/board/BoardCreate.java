...
public class BoardCreate extends JDBConnect{
	...
	public void findTable(String keyword) {
		...
		if(table_name.equals("@@null@@")) {
			...
			query = "CREATE TABLE "+keyword+" ( num number primary key, site varchar2(10) not null, title varchar2(1000) not null, content varchar2(2000) not null, regdate varchar2(15) not null, link varchar(1000) unique not null)";
			try {
